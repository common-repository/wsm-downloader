...
#wsmd_downloader_form_input{
    ...
    width : 80%;	
    height : 60px;
    border : 1px solid <?php echo esc_attr($wsmds_admin_options['shortcode']['customcolor']); ?>; 
    border-radius : 5px;
...
#wsmd_downloader_form_button{
    color: #ffffff;
    background : <?php echo esc_attr($wsmds_admin_options['shortcode']['customcolor']); ?>;
    font-size : 15px;
    width : 20%;	
    height : 60px;
    border : 1px dotted <?php echo esc_attr($wsmds_admin_options['shortcode']['customcolor']); ?>; 
    border-radius : 5px;
    margin-left : -5px;	
	outline : unset;	
...
table.wsmd_result_table th {
    ...
    background : <?php echo esc_attr($wsmds_admin_options['shortcode']['customcolor']); ?>;
	font-size : 15px;
    border : 3px solid <?php echo esc_attr($wsmds_admin_options['shortcode']['customcolor']); ?>  !important; 
...
button.wsmd_download_button {
    ...
    background : #272c33;
    font-size : 12px;
    border : 2px solid <?php echo esc_attr($wsmds_admin_options['shortcode']['customcolor']); ?>; 
    border-radius: 5px;
    outline: unset;
    padding: 6px;
}
